...
if cross is not None:
    ...
    say(f"    (~0.4-1%/mo). The unconditional disorder premium and the ΔG")
    say(f"    sign-inversion are therefore bounded as largely SURVIVORSHIP-DRIVEN,")
    say(f"    NOT a robust risk premium.")
say(f"\n  This agrees with R18 (actual delisted firms, accounting channel),")
say(f"  where the ΔS premium vanishes outright (FM t = +0.02).")
